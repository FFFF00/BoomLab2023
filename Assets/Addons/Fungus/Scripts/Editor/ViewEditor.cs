...
namespace Fungus.EditorUtils
{
    ...
    public class ViewEditor : Editor 
    {
        ...
        protected virtual void EditViewBounds()
        {
            ...
            for (int i = 0; i < 2; ++i)
            {
                var fmh_145_57_637895642465416863 = Quaternion.identity; var fmh_144_125_638217563629898573 = new Quaternion(); Vector3 newPos = Handles.FreeMoveHandle(handles[i],
